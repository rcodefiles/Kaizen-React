  ...
  return (
    <div className="blog-post-header11-blog-post-header3 thq-section-padding">
      <div className="blog-post-header11-max-width thq-section-max-width">
        <div className="blog-post-header11-content1 thq-flex-row">
          <img
          ...
          <div className="blog-post-header11-section-title thq-flex-column">
            <div className="blog-post-header11-breadcrumbs thq-flex-row">
              ...
              <span className="thq-body-small">
                {props.category ?? (
                  <Fragment>
                    <span className="blog-post-header11-text18">Education</span>
                  </Fragment>
                )}
              </span>
            </div>
            <div className="blog-post-header11-content2">
              <h1 className="blog-post-header11-title thq-heading-1">
                {props.blogPostTitle ?? (
                  <Fragment>
                    <span className="blog-post-header11-text19">
                      Empowering Students Through Kaizen: Transformative Change
                      in Schools
                    </span>
                  </Fragment>
                )}
              ...
              <div className="blog-post-header11-author">
                ...
                <span className="thq-body-small">
                  {props.avatarName ?? (
                    <Fragment>
                      <span className="blog-post-header11-text17">
                        KaizenSchools
                      </span>
                    </Fragment>
                  )}
              ...
              <div className="blog-post-header11-time">
                <span className="thq-body-small">
                  {props.date ?? (
                    <Fragment>
                      <span className="blog-post-header11-text15">
                        October 15, 2021
                      </span>
                    </Fragment>
                  )}
                ...
                <span className="thq-body-small">
                  {props.readTime ?? (
                    <Fragment>
                      <span className="blog-post-header11-text16">
                        5 minutes
                      </span>
                    </Fragment>
                  )}
...
BlogPostHeader11.defaultProps = {
  ...
  category: undefined,
  blogPostImageAlt: 'Students collaborating on a project',
  blogPostImageSrc:
    'https://images.unsplash.com/photo-1573166675921-076ea6b621ce?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MzgzODk3OXw&ixlib=rb-4.0.3&q=80&w=1080',
